...
** Library: string.h
** Description: scans the initial n bytes of the memory area pointed to
**				by s for the first instance of c. Both c and the bytes
**				of the memory area pointed to by s are interpreted as
**				unsigned char.
** Return value: a pointer to the matching byte or NULL if the
